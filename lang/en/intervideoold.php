...
$string['modulename_help'] = 'Use the intervideoold module for creating interactive videos.';
$string['intervideooldfieldset'] = 'Custom example fieldset';
$string['intervideooldname'] = 'Interactive video name';
